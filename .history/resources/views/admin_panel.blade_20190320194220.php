    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row'>
                    <div class='col'>
                        <input type='checkbox' name='filter_email' id='active' value='gmail'>
                        <label for='active'>Gmail</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_email' id='banned' value='wp'>
                        <label for='banned'>wp</label>
                    </div>
                </div>
            </div>
