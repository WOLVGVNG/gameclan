    ...
    <form action='/' method='GET'>
        <div class='row'>
            ...
            <div class='col'>
                ...
                <input type='radio' name='filtr_order' value='asc' id='asc' @if($filtr_order == 'asc') echo checked @endif>
                <label for='desc'>Descending</label>
                <input type='radio' name='filtr_order' value='desc' id='desc' @if($filtr_order == 'desc') echo checked @endif>
            </div>
        </div>
