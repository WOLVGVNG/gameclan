            ...
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row'>
                    <div class='col mx-auto'>
                        <input type='radio' name='filter_notifiable_email' id='notifiable_email' value=true @if(session('filter_notifiable_email')==true) echo checked @endif>
                        <label for='notifiable_email'>User allowed e-mail notifications</label>
                        <input type='radio' name='filter_notifiable_email' id='notifiable_email' value=false @if(session('filter_notifiable_email')==false) echo checked @endif>
