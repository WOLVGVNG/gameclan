        ...
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' id='filter-div'>
                ...
                <div class='row'>
                    ...
                    <div class='col'>
                        <input type='checkbox' name='filter_geo_nehterland' id='geo_nehterland' value='nehterland' @if(session('filter_geo_nehterland')=='nehterland') echo checked @endif>
                        <label for='connected_geo_nehterland'>Nehterland</label>
                    </div>
                    <div class='col'>
                        ...
                        <label for='connected_geo_germany'>Germany</label>
                    </div>
                </div>
