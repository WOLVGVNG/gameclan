        ...
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row'>
                    ...
                    <div class='col'>
                        <input type='checkbox' name='filter_email[]' id='protonmail' value='protonmail'>
                        <label for='protonmail'>ProtonMail</label>
                    </div>
                    <div class='col'>
                    ...
                    <div class='col'>
                        <input type='checkbox' name='filter_email[]' id='o2' value='o2'>
