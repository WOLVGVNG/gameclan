    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <input type='range' name='filter_points_switch' id='points_switch' value=true @if(session('filter_points_switch')==true) echo checked @endif>
                <label for='points_switch' class='font-weight-bold text-center'>Notifiable e-mails filter</label>
                <div class='row'>
                    <div class='col mx-auto'>
                        <div class='col-12'>
                            <input type='radio' name='filter_points' id='points_yes' value='true' @if(session('filter_points')=='true') echo checked @endif>
                            <label for='points_yes'>User allowed notifications</label>
                        </div>
                        <div class='col-12'>
                            <input type='radio' name='filter_points' id='points_no' value='false' @if(session('filter_points')=='false') echo checked @endif>
                            <label for='points_no'>User not allowed notifications</label>
                        </div>
                    </div>
                </div>
