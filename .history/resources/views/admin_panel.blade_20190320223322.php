        ...
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row'>
                    <div class='col mx-auto'>
                        <div class='col-12'>
                            <input type='checkbox' name='filter_connected_accounts' id='connected_accounts_yes' value='true' @if(session('filter_connected_accounts')=='true') echo checked @endif>
                            <label for='connected_accounts_yes'>Steam</label>
                        </div>
                        <div class='col-12'>
                            <input type='checkbox' name='filter_connected_accounts' id='connected_accounts_no' value='false' @if(session('filter_connected_accounts')=='false') echo checked @endif>
                            <label for='connected_accounts_no'>Facebook</label>
                        </div>
                    </div>
                </div>
