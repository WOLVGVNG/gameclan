    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <input type='checkbox' name='filter_email_provider' id='email_provider' value=true @if(session('filter_notifiable_email_switch')==true) echo checked @endif>
                ...
                <input type='checkbox' name='filter_email_provider' id='email_provider' value=true @if(session('filter_email_provider')==true) echo checked @endif>
                <label for='email_provider' class='font-weight-bold text-center'>Users' email's domains</label>
                <div class='row'>
                    <div class='col'>
