    ...
    <form action='/' method='GET'>
        <div class='row'>
            ...
            <div class='col-md-8'>
                <div class='row'>
                    <div class='col'>
                        <p class='font-weight-bold'>Sort by column type</p>
                    ...
                    <div class='col'>
                        <p class='font-weight-bold'>Sort by order</p>
                        <input type='radio' class='custom-control-input' name='sort_order' value='asc' id='asc'
