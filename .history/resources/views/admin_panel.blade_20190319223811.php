    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col'>
                ...
                <select name='filtr_type' value='{{ session('filtr_type') }}'>
                    <option>{{ session('filtr_type') }}</option>
                    <option>id</option>
            ...
            <div class='col'>
                ...
                <input type='radio' name='filtr_order' value='asc' id='asc'
                        @if(session('filtr_order') == 'asc') echo checked @endif>
                <label for='desc'>Descending</label>
                <input type='radio' name='filtr_order' value='desc' id='desc'
                        @if(session('filtr_order') == 'desc') echo checked @endif>
            </div>
        </div>
        <div class='row mt-2 mb-5'>
            <div class='col-12'>
                <button type='submit' class='btn btn-block btn-primary'>Apply filtr</button>
            </div>
        </div>
    </form>
