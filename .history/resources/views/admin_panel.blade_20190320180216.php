    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row mt-5'>
                    <div class='col'>
                        <input type='checkbox' name='filter_active' id='filter_active' @if(session('fiter_active') == 'id') echo checked @endif>
                        <label for='filter_active'>Active</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_banned' id='filter_banned' @if(session('fiter_banned') == 'id') echo checked @endif>
                        <label for='filter_banned'>Banned</label>
                    </div>
                </div>
            </div>
                ...
                <div class='row'>
                    <div class='col-sm-6'>
                        ...
                        <select class='form-control w-50 mx-auto' name='sort_type' value='{{ session('sort_type') }}'>
                            ...
                            <option value='active' @if(session('sort_type') == 'active') echo selected @endif>Active</option>
                            <option value='banned' @if(session('sort_type') == 'banned') echo selected @endif>Banned</option>
