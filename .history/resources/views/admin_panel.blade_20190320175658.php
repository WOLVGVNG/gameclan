...
<div class='container text-center'>
    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-2 px-md-5' style='border-right: 1px solid black'>
                <!-----------------------------SZUKANIE---------------------------->
                <div class='row'>
                ...
                <div class='row mt-5'>
                    ...
                    <div class='col'>
                        <input type='checkbox' name='filter_banned' id='filter_banned' value='{{ session('filter_banned') }}'>
                        <label for='filter_banned'>Banned</label>
                    </div>
                </div>
            </div>

            <div class='col-md-8 px-2 px-md-5'>
                <!-----------------------------SORTOWANIE---------------------------->
                <div class='row'>
                    <div class='col-sm-6'>
