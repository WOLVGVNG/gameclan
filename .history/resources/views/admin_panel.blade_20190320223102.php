    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <label for='connected_accounts_switch' class='font-weight-bold text-center'>User connected_accounts (shows users whose connected_accounts are above, or equal to set number)</label>
                <div class='row'>
                    <div class='col mx-auto'>
                        <div class='col-12'>
                            <input type='number' name='filter_connected_accounts' value={{session('filter_connected_accounts')}}>
                        </div>
                    </div>
                </div>
