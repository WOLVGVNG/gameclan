    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' id='filter-div'>
                ...
                {{--<input type='checkbox' name='filter_emails_switch' id='email_switch' value=true @if(session('filter_emails_switch')==true) echo checked @endif>
                <label for='email_switch' class='font-weight-bold text-center'>Users' email's providers</label>
                <div class='row'>
                    <div class='col'>
                        <input type='checkbox' name='filter_emails[]' id='gmail' value='gmail'>
                        <label for='gmail'>Gmail</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_emails[]' id='outlook' value='outlook'>
                        <label for='outlook'>Outlook</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_emails[]' id='yahoo' value='yahoo'>
                        <label for='yahoo'>Yahoo</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_emails[]' id='yandex' value='yandex'>
                        <label for='yandex'>Yandex</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_emails[]' id='icloud' value='icloud'>
                        <label for='icloud'>Icloud</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_emails[]' id='onet' value='onet'>
                ...
                <label for='points_switch' class='font-weight-bold text-center'>User points (shows users whose points are above, or equal to set number)</label>
                <div class='row'>
                    <div class='col-12'>
                ...
                <label for='connected_accounts_switch' class='font-weight-bold text-center'>Connected accounts</label>
                <div class='row'>
                    <div class='col'>
                ...
                <label for='geo_switch' class='font-weight-bold text-center'>Connected accounts</label>
                <div class='row'>
                    <div class='col'>
                        <input type='checkbox' name='filter_geo_steam' id='geo_steam' value='steam' @if(session('filter_geo_steam')=='steam') echo checked @endif>
                        <label for='geo_steam'>Steam</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_geo_facebook' id='geo_facebook' value='facebook' @if(session('filter_geo_facebook')=='facebook') echo checked @endif>
                        <label for='geo_facebook'>Facebook</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_geo_google' id='geo_google' value='google' @if(session('filter_geo_google')=='google') echo checked @endif>
                        <label for='connected_geo_google'>Google</label>
                    </div>
                </div>
                ...
                <div class='row'>
                    <button type='submit' class='btn btn-primary mt-3 mx-auto'>Sort</button>
                </div>
            </div>
