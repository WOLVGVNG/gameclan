    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <label for='points_switch' class='font-weight-bold text-center'>User points (shows users whose points are above set range)</label>
                <div class='row'>
                    <div class='col mx-auto'>
                        <div class='col-12'>
                            <input type='range' name='filter_points' min='0' max='10000' step= value='true' @if(session('filter_points')=='true') echo checked @endif>
                        </div>
                    </div>
                </div>
