    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' id='filter-div'>
                ...
                <label for='lang_switch' class='font-weight-bold text-center'>User language</label>
                <div class='row'>
                    <div class='col'>
