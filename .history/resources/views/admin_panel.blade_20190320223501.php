    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row'>
                    <div class='col'>
                        <input type='checkbox' name='filter_connected_accounts' id='connected_accounts_steam' value='strue' @if(session('filter_connected_accounts_steam')=='true') echo checked @endif>
                        <label for='connected_accounts_steam'>Steam</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_connected_accounts' id='connected_accounts_facebook' value='true' @if(session('filter_connected_accounts_facebook')=='true') echo checked @endif>
                        <label for='connected_accounts_google'>Facebook</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_connected_accounts' id='connected_accounts_google' value='true' @if(session('filter_connected_accounts_google')=='true') echo checked @endif>
                        <label for='connected_accounts_google'>Foogle</label>
                    </div>
                </div>
