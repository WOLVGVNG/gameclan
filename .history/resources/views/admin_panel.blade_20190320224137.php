                    ...
                    <div class='col'>
                        <input type='checkbox' name='filter_connected_accounts[]' id='connected_accounts_steam' value='steam'
                            @foreach(session('filter_connected_accounts') as $key => $value)
                                @if($value=='steam') echo checked @endif
                            @endforeach
                        >
                        <label for='connected_accounts_steam'>Steam</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_connected_accounts[]' id='connected_accounts_facebook' value='facebook'
                            @foreach(session('filter_connected_accounts') as $key => $value)
                                @if($value=='facebook') echo checked @endif
                            @endforeach
                        >
                        <label for='connected_accounts_google'>Facebook</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_connected_accounts[]' id='connected_accounts_google' value='google'
                            @foreach(session('filter_connected_accounts') as $key => $value)
                                @if($value=='google') echo checked @endif
                            @endforeach
                        >
