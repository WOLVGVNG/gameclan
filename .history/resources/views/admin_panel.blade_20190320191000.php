    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row mt-5'>
                    <div class='col'>
                        <input type='radio' name='filter_active' id='active' value=true @if(session('fiter_active')) echo checked @endif>
                        <label for='active'>Active</label>
                    </div>
                    <div class='col'>
                        <input type='radio' name='filter_banned' id='banned' value=true @if(session('fiter_banned')) echo checked @endif>
