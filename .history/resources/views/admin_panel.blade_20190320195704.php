    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row'>
                    <div class='col'>
                        <input type='radio' name='filter_active' id='active' value='active' @if(session('filter_active')==true) echo checked @endif>
                        <label for='active'>User is active</label>
                    </div>
                    <div class='col'>
                        <input type='radio' name='filter_active' id='banned' value='banned' @if(session('filter_banned')==true) echo checked @endif>
