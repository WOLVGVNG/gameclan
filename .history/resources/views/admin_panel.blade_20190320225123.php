        ...
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row'>
                    ...
                    <div class='col'>
                        <input type='checkbox' name='filter_connected_accounts_google' id='connected_accounts_facebook' value='true' @if(session('filter_connected_accounts_facebook')=='true') echo checked @endif>
