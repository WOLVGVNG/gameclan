    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <!-----------------------------FILTROWANIE---------------------------->
                <input type='checkbox' name='filter_active_or_banned' id='active_or_banned' value=true @if(session('filter_active_or_banned')==true) echo checked @endif>
                <label for='active_or_banned' class='font-weight-bold text-center'>Active or banned filter</label>
                <div class='row'>
                    <div class='col'>
                ...
                <input type='checkbox' name='filter_notifiable_email_or_not' id='notifiable_email_or_not' value=true @if(session('filter_notifiable_email_or_not')==true) echo checked @endif>
                <label for='notifiable_email_or_not' class='font-weight-bold text-center'>Notifiable e-mails filter</label>
                <div class='row'>
                    <div class='col mx-auto'>
                        <input type='checkbox' name='filter_notifiable_email' id='notifiable_email' value=true @if(session('filter_notifiable_email')==true) echo checked @endif>
                        <label for='notifiable_email'>User allowed e-mail notifications</label>
                        <input type='checkbox' name='filter_notifiable_email' id='notifiable_email' value=false @if(session('filter_notifiable_email')==false) echo checked @endif>
                        <label for='notifiable_email'>User not allowed e-mail notifications</label>
                    </div>
                </div>

                <hr>

                <p class='font-weight-bold text-center'>Users' email's providers</p>
                <div class='row'>
                    <div class='col'>
                    ...
                    <div class='col'>
                        <input type='checkbox' name='filter_email[]' id='wp' value='wp'>
