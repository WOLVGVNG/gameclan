    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' id='filter-div'>
                ...
                <label for='geo_switch' class='font-weight-bold text-center'>User country</label>
                <div class='row'>
                    <div class='col'>
                ...
                <label for='lang_switch' class='font-weight-bold text-center'>User country</label>
                <div class='row'>
                    <div class='col'>
                        <input type='checkbox' name='filter_lang_pl' id='lang_pl' value='pl' @if(session('filter_lang_pl')=='pl') echo checked @endif>
                        <label for='lang_pl'>Poland</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_lang_en' id='lang_en' value='en' @if(session('filter_lang_en')=='en') echo checked @endif>
                        <label for='lang_en'>England</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_lang_nl' id='lang_nl' value='nl' @if(session('filter_lang_nl')=='nl') echo checked @endif>
                        <label for='lang_nl'>Netherland</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_lang_germany' id='lang_germany' value='germany' @if(session('filter_lang_germany')=='germany') echo checked @endif>
                        <label for='lang_germany'>Germany</label>
                    </div>
                </div>
