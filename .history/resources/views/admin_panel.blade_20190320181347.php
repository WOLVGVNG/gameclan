    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row mt-5'>
                    <div class='col'>
                        <input type='checkbox' name='filter_active' id='active' @if(session('fiter_active') == 'bannded') echo checked @endif>
                        <label for='active'>Active</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_active' id='banned' @if(session('fiter_active') == 'active') echo checked @endif>
