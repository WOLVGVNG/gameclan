    ...
    <form action='/' method='GET'>
        <div class='row'>
            <div class='col-md-4 px-4 px-md-5' style='border-right: 3px solid gray'>
                ...
                <div class='row'>
                    <div class='col'>
                        <input type='checkbox' name='filter_connected_accounts_steam' id='connected_accounts_steam' value='facebook' @if(session('filter_connected_accounts_steam')=='facebook') echo checked @endif>
                        <label for='connected_accounts_steam'>Steam</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_connected_accounts_facebook' id='connected_accounts_facebook' value='steam' @if(session('filter_connected_accounts_facebook')=='google') echo checked @endif>
                        <label for='connected_accounts_facebook'>Facebook</label>
                    </div>
                    <div class='col'>
                        <input type='checkbox' name='filter_connected_accounts_google' id='connected_accounts_google' value='google' @if(session('filter_connected_accounts_google')=='facebook') echo checked @endif>
