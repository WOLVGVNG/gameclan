        ...
        $users = User::orderBy(session('sort_type'), session('sort_order'))
            ...
            ->where('banned', 'LIKE',
                ...
                ?
                    ...
                    :
                    '%%')
            ->when(session('filter_notifiable_email_switch')==true && session('filter_notifiable_email'), funciton($q) {
                $q->where('notifiable_email', 'LIKE', (session('filter_notifiable_email') == 'true'?truefalse):'%%');
            })
